...
public class MultasCRUD implements MultasCRUDimpl{
    ...
    public List<Multas> obtenerMultas(Coches coches) {
        ...
        try (Session session = factory.openSession()) {
            ...
            listadoMultas = session.createQuery("from Multas WHERE coches.matricula = :matricula", Multas.class) //obtiene las multas asociadas al coche
    ...
    public boolean comprobarIdMulta(int id) {
        ArrayList<Multas> lista = getMultas(); //obtiene la lista de multas
