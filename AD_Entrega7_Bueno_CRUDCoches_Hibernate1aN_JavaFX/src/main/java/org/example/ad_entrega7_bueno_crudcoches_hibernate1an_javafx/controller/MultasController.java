...
public class MultasController implements Initializable {
    ...
    //instancia de Coches para manejar el coche seleccionado
    Coches coche;
    ...
    public void metod(Coches coches) {
        coche = coches; //asigna el coche recibido
        System.out.println(coches); //imprime información del coche
        txtfmatricula.setText(coche.getMatricula()); //muestra la matrícula del coche
    ...
    //método que se ejecuta al iniciar la vista y configura las columnas de la tabla
    @Override
